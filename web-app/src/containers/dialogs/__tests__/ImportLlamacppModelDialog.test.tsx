  ...
  useTranslation: () => ({
    t: (key: string) =>
      ({
        ...
        'providers:importModel': 'Import Model',
        'providers:selectGgufFile': 'Select GGUF File',
        'providers:selectMmprojFile': 'Select MMPROJ File',
        'providers:modelValidationError': 'Model Validation Error',
        'providers:mmprojValidationError': 'MMProj Validation Error',
        'providers:modelExists': 'Model already exists',
        'providers:modelAlreadyImported': 'Model already imported',
        'providers:modelImported': 'Model imported successfully',
        'providers:modelHasBeenImported': 'Model has been imported',
        'providers:modelImportFailed': 'Failed to import model',
      })[key] ?? key,
  }),
}))
